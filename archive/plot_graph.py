...
def main():
    ...
    unoptimized_trajectory = optimizer_to_map(GRAPH.vertices, GRAPH.unoptimized_graph)
    optimized_trajectory = optimizer_to_map(GRAPH.vertices, GRAPH.optimized_graph)
    ...
    location_marker = "."
    axes.plot(
        unoptimized_trajectory["locations"][:, 0],
    ...
    axes.plot(
        optimized_trajectory["locations"][:, 0],
    ...
    axes.plot(
        unoptimized_trajectory["waypoints"][:, 0],
    ...
    axes.plot(
        optimized_trajectory["waypoints"][:, 0],
