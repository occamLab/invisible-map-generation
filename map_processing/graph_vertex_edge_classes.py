...
from .data_models import OComputeInfParams, Variances
...
class Edge:
    ...
    def _compute_information_se3_obs(self, weights_vec: np.ndarray, tag_var: float = Variances()) -> None:
        self.information = np.diag(weights_vec*tag_var.reciprocal_vector)
